...
local_rss_dir <- 'C:/Users/msears/Documents/RSS/CARE_WD HW/' # local directory where you want this repo copied. Should be something like 'C:/Users/adillon/Documents/RSS/CONG'
...
WB_GCMs = c("MIROC-ESM.rcp45","inmcm4.rcp45") # Specific models need to be selected to run the Water Balance scripts
...
inputs <- c(paste0(SiteID, "_lat_long_PRISM_PptTminTmax_IntermediateFiles.RData"), 
            paste0(SiteID, "_init_parsed.RData"), 
            "GridMet.csv")
